...
import OnlineTransactionTable from "../components/onlineTransaction/OnlineTransactionTable";
import OnlineTransactionDrawer from "../components/onlineTransaction/OnlineTransactionDrawer";

export default function OnlineTransactionPage() {
