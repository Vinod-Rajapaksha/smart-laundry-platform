...
import CODTable from "../components/cod/CODTable";
import CODDrawer from "../components/cod/CODDrawer";
...
export default function CODPage() {
  ...
  return (
    <div className="w-full max-w-[1256px] mx-auto space-y-6 animate-in fade-in duration-500 font-poppins">
      ...
      {/* Table Section */}
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-emerald-200/20 overflow-hidden">
        <CODTable 
          data={codTransfers} 
          loading={loading} 
