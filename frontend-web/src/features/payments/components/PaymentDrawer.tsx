...
export default function PaymentDrawer({ payment, onClose, onVerify, loading }: PaymentDrawerProps) {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 p-8 space-y-10">
            ...
            <div className="text-center p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
               ...
               <div className={`mx-auto w-fit px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border shadow-sm ${
            ...
            <div className="grid gap-6">
               ...
               <div className="flex items-start gap-4 p-4 border border-slate-100 rounded-2xl shadow-sm">
                  ...
                  <div>
                     ...
                     <p className="font-bold text-slate-800 text-sm">{payment.paidAt ? format(new Error(payment.paidAt), "MMMM dd, HH:mm:ss") : "--"}</p>
                  </div>
               </div>
            </div>
