...
interface OnlineTransactionFiltersProps {
  activeTab: string;
...
export const OnlineTransactionFilters = ({
  activeTab,
  onTabChange,
  searchQuery,
  onSearchChange,
}: OnlineTransactionFiltersProps) => {
  return (
    <div className="bg-white p-4 mx-4 md:mx-0 rounded-3xl border border-slate-100 shadow-sm space-y-4 font-poppins">
      <div className="flex flex-col lg:flex-row justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            type="text"
            placeholder="Order ID, Customer Name, Gateway Hash"
            value={searchQuery}
